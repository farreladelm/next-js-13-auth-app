    ...
    return (
        <div className="flex justify-center items-center min-h-screen w-screen">
            <div className="p-4 rounded-md min-w-[300px]">
                <h1 className="p-4 text-center text-2xl font-bold">Login Form</h1>
                ...
                <div className="py-4">
                    <div>
                        ...
                        <div className="flex flex-col justify-center items-center gap-2 my-4">
                            <button onClick={onLogin} className="flex gap-2 justify-center items-center px-4 py-2 bg-slate-950 hover:bg-slate-800 focus:bg-slate-800 border-2 border-solid border-slate-300 rounded" disabled={buttonDisabled}>
                            <span>Login</span>
                            {   
                                loading ?
                                    <div role="status">
